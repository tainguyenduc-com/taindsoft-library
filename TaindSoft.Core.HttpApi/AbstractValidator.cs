...
namespace TaindSoft.Core.HttpApi
{
    ...
    internal class ValidationRule<T, TProperty>(string propertyName, Func<T, TProperty> propertyFunc) : IValidationRule<T>
    {
        ...
        private readonly List<PropertyValidatorBase<T, TProperty>> _validators = [];

        public void AddValidator(PropertyValidatorBase<T, TProperty> validator)
        {
        ...
        public IEnumerable<ValidationFailure> Validate(T instance)
        {
            ...
            foreach (PropertyValidatorBase<T, TProperty> validator in _validators)
            {
    ...
    /// <summary>
    /// TODO: Document class RuleBuilder
    /// </summary>
